...
public class SkyEffectsProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if ((entity.level().dimension()) == (ResourceKey.create(Registries.DIMENSION, new ResourceLocation("farout:proxmai")))) {
			...
			renderTexture(60, -90, (float) (world.dayTime() * 0.015), 0, (int) (255 << 24 | 255 << 16 | 255 << 8 | 255), false);
			...
			renderTexture(24, -90, (float) (world.dayTime() * 0.015), 0, (int) (255 << 24 | 255 << 16 | 255 << 8 | 255), false);
			...
			renderTexture(12, -90, (float) (world.dayTime() * 0.015), 0, (int) (255 << 24 | 255 << 16 | 255 << 8 | 255), false);
			...
			renderTexture(6, -90, (float) (world.dayTime() * 0.015), 0, (int) (255 << 24 | 255 << 16 | 255 << 8 | 255), false);
		} else if ((entity.level().dimension()) == (ResourceKey.create(Registries.DIMENSION, new ResourceLocation("farout:carbos")))) {
			{
				ResourceLocation _texturelocation = new ResourceLocation(("minecraft" + ":textures/" + "enviroment/sun" + ".png"));
				RenderSystem.setShaderTexture(0, _texturelocation);
				Minecraft.getInstance().getTextureManager().bindForSetup(_texturelocation);
			}
		...
		renderStars(1500, 432435, 90, (float) (world.getTimeOfDay(Minecraft.getInstance().getPartialTick()) * 360.0F), 0, (int) (255 << 24 | 255 << 16 | 229 << 8 | 124), false);
		renderStars(300, 35465, 90, (float) (world.getTimeOfDay(Minecraft.getInstance().getPartialTick()) * 360.0F), 0, (int) (255 << 24 | 145 << 16 | 175 << 8 | 124), false);
		renderStars(1000, 57678, 90, (float) (world.getTimeOfDay(Minecraft.getInstance().getPartialTick()) * 360.0F), 0, (int) (255 << 24 | 145 << 16 | 0 << 8 | 0), false);
