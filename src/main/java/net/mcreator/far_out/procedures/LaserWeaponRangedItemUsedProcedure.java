...
public class LaserWeaponRangedItemUsedProcedure {
					...
					if (!_level.isClientSide()) {
						_level.playSound(null,
								new BlockPos(
										...
										entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(raytrace_distance)), ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE, entity))
												.getBlockPos().getZ()),
								ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("farout:electric_hum")), SoundSource.NEUTRAL, 1, 1);
					} else {
						_level.playLocalSound(
								...
								(entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(raytrace_distance)), ClipContext.Block.COLLIDER, ClipContext.Fluid.NONE, entity))
										.getBlockPos().getZ()),
								ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("farout:electric_hum")), SoundSource.NEUTRAL, 1, 1, false);
					}
				}
				{
