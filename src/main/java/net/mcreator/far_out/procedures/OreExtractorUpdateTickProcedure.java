...
public class OreExtractorUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		ItemStack ExtractedBlock = ItemStack.EMPTY;
		double XOffset = 0;
		double YOffset = 0;
		if (new Object() {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "Operating")) {
			ExtractedBlock = (new ItemStack((world.getBlockState(BlockPos.containing(x, (new Object() {
			...
			}.getValue(world, BlockPos.containing(x, y, z), "YLevel")) - YOffset, z))).getBlock()));
			if (!(ExtractedBlock.getItem() == FaroutModBlocks.ORE_EXTRACTOR.get().asItem())) {
				if (ExtractedBlock.getItem() == (new Object() {
				...
				}.getAmount(world, BlockPos.containing(x, y, z), 0) == 0) {
					{
						...
						if (_ent != null) {
							final int _slotid = 0;
							final ItemStack _setstack = ExtractedBlock;
				...
				} else if (ExtractedBlock.getItem() == (new Object() {
					public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						BlockEntity _ent = world.getBlockEntity(pos);
						if (_ent != null)
