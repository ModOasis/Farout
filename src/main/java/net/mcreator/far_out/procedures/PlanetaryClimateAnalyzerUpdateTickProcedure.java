...
public class PlanetaryClimateAnalyzerUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (0 <= FaroutModVariables.WorldVariables.get(world).Energy) {
			...
			}.getValue(world, BlockPos.containing(x, y, z), "ScienceMultiplier")) * 0.5;
			FaroutModVariables.MapVariables.get(world).syncData(world);
			FaroutModVariables.WorldVariables.get(world).Energy = FaroutModVariables.WorldVariables.get(world).Energy - 7;
