...
public class ElectrolyzerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public ElectrolyzerBlockEntity(BlockPos position, BlockState state) {
		super(FaroutModBlockEntities.ELECTROLYZER.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new ElectrolyzerGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
