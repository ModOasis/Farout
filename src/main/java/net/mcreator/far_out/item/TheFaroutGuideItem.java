...
import net.mcreator.far_out.item.inventory.TheFaroutGuideInventoryCapability;
...
public class TheFaroutGuideItem extends Item {
	public TheFaroutGuideItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("A guide on how to survive and thrive in this mod."));
	}
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("The Farout Guide");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new TableOfContentsMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new TheFaroutGuideInventoryCapability();
	}
