...
public abstract class DiamondReinfocedSpaceSuitItem extends ArmorItem {
	public DiamondReinfocedSpaceSuitItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "diamond_reinfoced_space_suit";
			}
	...
	public static class Helmet extends DiamondReinfocedSpaceSuitItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "farout:textures/entities/diamondspacesuit.png";
		}
	}

	public static class Chestplate extends DiamondReinfocedSpaceSuitItem {
		public Chestplate() {
	...
	public static class Leggings extends DiamondReinfocedSpaceSuitItem {
		public Leggings() {
