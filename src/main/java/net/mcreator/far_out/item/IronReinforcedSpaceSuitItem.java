...
public abstract class IronReinforcedSpaceSuitItem extends ArmorItem {
	public IronReinforcedSpaceSuitItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "iron_reinforced_space_suit";
			}
	...
	public static class Helmet extends IronReinforcedSpaceSuitItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "farout:textures/entities/ironspacesuit.png";
		}
	}

	public static class Chestplate extends IronReinforcedSpaceSuitItem {
		public Chestplate() {
	...
	public static class Leggings extends IronReinforcedSpaceSuitItem {
		public Leggings() {
