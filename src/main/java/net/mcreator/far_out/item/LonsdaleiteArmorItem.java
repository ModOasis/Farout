...
public abstract class LonsdaleiteArmorItem extends ArmorItem {
	public LonsdaleiteArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends LonsdaleiteArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "farout:textures/models/armor/lonsdaleite_layer_1.png";
		}
	}
	...
	public static class Leggings extends LonsdaleiteArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "farout:textures/models/armor/lonsdaleite_layer_2.png";
		}
	}
