...
public class ElectrolyzerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ElectrolyzerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FaroutModMenus.ELECTROLYZER_GUI.get(), id);
