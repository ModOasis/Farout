...
public class ZPinchFusionReactorGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ZPinchFusionReactorGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FaroutModMenus.Z_PINCH_FUSION_REACTOR_GUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 52, 62) {
			...
			@Override
			public boolean mayPlace(ItemStack stack) {
				return FaroutModItems.TRITIUM.get() == stack.getItem();
			}
		}));
