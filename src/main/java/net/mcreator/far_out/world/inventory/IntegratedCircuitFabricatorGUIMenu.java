...
public class IntegratedCircuitFabricatorGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public IntegratedCircuitFabricatorGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
