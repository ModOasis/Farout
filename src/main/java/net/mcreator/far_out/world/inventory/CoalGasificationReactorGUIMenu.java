...
public class CoalGasificationReactorGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CoalGasificationReactorGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FaroutModMenus.COAL_GASIFICATION_REACTOR_GUI.get(), id);
