...
public class HydrogenFuelCellGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HydrogenFuelCellGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FaroutModMenus.HYDROGEN_FUEL_CELL_GUI.get(), id);
