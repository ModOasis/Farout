...
public class FusionreactorguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FusionreactorguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FaroutModMenus.FUSIONREACTORGUI.get(), id);
