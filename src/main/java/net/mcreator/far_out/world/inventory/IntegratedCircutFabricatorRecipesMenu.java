...
public class IntegratedCircutFabricatorRecipesMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public IntegratedCircutFabricatorRecipesMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FaroutModMenus.INTEGRATED_CIRCUT_FABRICATOR_RECIPES.get(), id);
