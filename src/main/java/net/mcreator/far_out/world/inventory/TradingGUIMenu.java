...
import net.mcreator.far_out.procedures.TradingGUIThisGUIIsOpenedProcedure;
...
public class TradingGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TradingGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
