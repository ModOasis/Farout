...
public class CardboardboxguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CardboardboxguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FaroutModMenus.CARDBOARDBOXGUI.get(), id);
		...
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 25, 44) {
			private final int slot = 5;
		}));
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 52, 44) {
		...
		this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 133, 44) {
