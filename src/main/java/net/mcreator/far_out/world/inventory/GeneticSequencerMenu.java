...
public class GeneticSequencerMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GeneticSequencerMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FaroutModMenus.GENETIC_SEQUENCER.get(), id);
