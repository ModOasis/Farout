...
public class MuddyHillsTrunkDecorator extends TrunkVineDecorator {
	public static Codec<MuddyHillsTrunkDecorator> CODEC = Codec.unit(MuddyHillsTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("muddy_hills_tree_trunk_decorator", DECORATOR_TYPE));
	}
