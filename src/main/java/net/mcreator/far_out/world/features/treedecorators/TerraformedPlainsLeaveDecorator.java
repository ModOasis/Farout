...
public class TerraformedPlainsLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(TerraformedPlainsLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("terraformed_plains_tree_leave_decorator", DECORATOR_TYPE));
	}

	public TerraformedPlainsLeaveDecorator() {
		super(0.25f);
	}
