...
public class TerraformedPlainsTrunkDecorator extends TrunkVineDecorator {
	public static Codec<TerraformedPlainsTrunkDecorator> CODEC = Codec.unit(TerraformedPlainsTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("terraformed_plains_tree_trunk_decorator", DECORATOR_TYPE));
	}
