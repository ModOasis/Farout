...
public class SunnyIslandsTrunkDecorator extends TrunkVineDecorator {
	public static Codec<SunnyIslandsTrunkDecorator> CODEC = Codec.unit(SunnyIslandsTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("sunny_islands_tree_trunk_decorator", DECORATOR_TYPE));
	}
