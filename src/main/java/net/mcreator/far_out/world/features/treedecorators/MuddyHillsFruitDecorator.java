...
public class MuddyHillsFruitDecorator extends CocoaDecorator {
	public static Codec<MuddyHillsFruitDecorator> CODEC = Codec.unit(MuddyHillsFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("muddy_hills_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public MuddyHillsFruitDecorator() {
		super(0.2f);
	}
