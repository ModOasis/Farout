...
public class ModelUnfittedLaunchVehicle<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("farout", "model_unfitted_launch_vehicle"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(72, 90).addBox(-12.0F, -230.25F, -12.0F, 24.0F, 68.0F, 24.0F, new CubeDeformation(12.0F)).texOffs(0, 0).addBox(-12.0F, -120.0F, -12.0F, 24.0F, 90.0F, 24.0F, new CubeDeformation(18.0F))
						.texOffs(168, 104).addBox(-8.0F, -12.0F, -8.0F, 16.0F, 12.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(168, 104).addBox(14.0F, -12.0F, -8.0F, 16.0F, 12.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(168, 104)
						.addBox(-30.0F, -12.0F, -8.0F, 16.0F, 12.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(168, 104).addBox(-8.0F, -12.0F, -30.0F, 16.0F, 12.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(168, 104)
