...
public class ModelSpaceSuit<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = SpaceSuit.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(32, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.15F, 16.0F, -3.75F));
		PartDefinition LeftLeg = SpaceSuit.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(32, 48).addBox(-1.5F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.35F, 16.0F, -3.75F));
