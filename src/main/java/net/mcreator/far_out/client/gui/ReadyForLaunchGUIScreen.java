...
public class ReadyForLaunchGUIScreen extends AbstractContainerScreen<ReadyForLaunchGUIMenu> {
	private final static HashMap<String, Object> guistate = ReadyForLaunchGUIMenu.guistate;
