...
import net.mcreator.far_out.network.RejonaGUIInterstellarButtonMessage;
...
public class RejonaGUIInterstellarScreen extends AbstractContainerScreen<RejonaGUIInterstellarMenu> {
	private final static HashMap<String, Object> guistate = RejonaGUIInterstellarMenu.guistate;
	...
	public RejonaGUIInterstellarScreen(RejonaGUIInterstellarMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/rejona_gui_interstellar.png");
	...
	public void init() {
		...
		imagebutton_settrajectory3 = new ImageButton(this.leftPos + 123, this.topPos + 147, 64, 64, 0, 0, 64, new ResourceLocation("farout:textures/screens/atlas/imagebutton_settrajectory3.png"), 64, 128, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new RejonaGUIInterstellarButtonMessage(0, x, y, z));
				RejonaGUIInterstellarButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_settrajectory2 = new ImageButton(this.leftPos + 64, this.topPos + 64, 32, 32, 0, 0, 32, new ResourceLocation("farout:textures/screens/atlas/imagebutton_settrajectory2.png"), 32, 64, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new RejonaGUIInterstellarButtonMessage(1, x, y, z));
				RejonaGUIInterstellarButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
