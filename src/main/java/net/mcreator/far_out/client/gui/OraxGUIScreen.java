...
import net.mcreator.far_out.network.OraxGUIButtonMessage;
...
public class OraxGUIScreen extends AbstractContainerScreen<OraxGUIMenu> {
	private final static HashMap<String, Object> guistate = OraxGUIMenu.guistate;
	...
	public OraxGUIScreen(OraxGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/orax_gui.png");
	...
	public void init() {
		...
		imagebutton_settrajectory3 = new ImageButton(this.leftPos + 48, this.topPos + 57, 128, 128, 0, 0, 128, new ResourceLocation("farout:textures/screens/atlas/imagebutton_settrajectory3.png"), 128, 256, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new OraxGUIButtonMessage(0, x, y, z));
				OraxGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_settrajectory2 = new ImageButton(this.leftPos + 94, this.topPos + 2, 16, 16, 0, 0, 16, new ResourceLocation("farout:textures/screens/atlas/imagebutton_settrajectory2.png"), 16, 32, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new OraxGUIButtonMessage(1, x, y, z));
				OraxGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
