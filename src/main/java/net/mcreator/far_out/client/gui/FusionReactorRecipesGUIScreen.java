...
import net.mcreator.far_out.network.FusionReactorRecipesGUIButtonMessage;
...
public class FusionReactorRecipesGUIScreen extends AbstractContainerScreen<FusionReactorRecipesGUIMenu> {
	private final static HashMap<String, Object> guistate = FusionReactorRecipesGUIMenu.guistate;
	...
	public FusionReactorRecipesGUIScreen(FusionReactorRecipesGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/fusion_reactor_recipes_gui.png");
	...
	public void init() {
		...
		imagebutton_arrow_left = new ImageButton(this.leftPos + 60, this.topPos + 61, 16, 16, 0, 0, 16, new ResourceLocation("farout:textures/screens/atlas/imagebutton_arrow_left.png"), 16, 32, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new FusionReactorRecipesGUIButtonMessage(0, x, y, z));
				FusionReactorRecipesGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		guistate.put("button:imagebutton_arrow_left", imagebutton_arrow_left);
		this.addRenderableWidget(imagebutton_arrow_left);
		imagebutton_arrow = new ImageButton(this.leftPos + 114, this.topPos + 61, 16, 16, 0, 0, 16, new ResourceLocation("farout:textures/screens/atlas/imagebutton_arrow.png"), 16, 32, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new FusionReactorRecipesGUIButtonMessage(1, x, y, z));
				FusionReactorRecipesGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
