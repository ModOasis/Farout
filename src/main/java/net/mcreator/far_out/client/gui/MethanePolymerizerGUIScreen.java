...
public class MethanePolymerizerGUIScreen extends AbstractContainerScreen<MethanePolymerizerGUIMenu> {
	private final static HashMap<String, Object> guistate = MethanePolymerizerGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MethanePolymerizerGUIScreen(MethanePolymerizerGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/methane_polymerizer_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.farout.methane_polymerizer_gui.label_electrolyzer"), 42, 7, -12829636, false);
	}
