...
import net.mcreator.far_out.network.FormalonMainButtonMessage;
...
public class FormalonMainScreen extends AbstractContainerScreen<FormalonMainMenu> {
	private final static HashMap<String, Object> guistate = FormalonMainMenu.guistate;
	...
	public FormalonMainScreen(FormalonMainMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/formalon_main.png");
	...
	public void init() {
		...
		imagebutton_settrajectory = new ImageButton(this.leftPos + 79, this.topPos + 131, 16, 16, 0, 0, 16, new ResourceLocation("farout:textures/screens/atlas/imagebutton_settrajectory.png"), 16, 32, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new FormalonMainButtonMessage(0, x, y, z));
				FormalonMainButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_settrajectory1 = new ImageButton(this.leftPos + 40, this.topPos + 60, 16, 16, 0, 0, 16, new ResourceLocation("farout:textures/screens/atlas/imagebutton_settrajectory1.png"), 16, 32, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new FormalonMainButtonMessage(1, x, y, z));
				FormalonMainButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_settrajectory2 = new ImageButton(this.leftPos + 184, this.topPos + 17, 16, 16, 0, 0, 16, new ResourceLocation("farout:textures/screens/atlas/imagebutton_settrajectory2.png"), 16, 32, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new FormalonMainButtonMessage(2, x, y, z));
				FormalonMainButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_zoom_out = new ImageButton(this.leftPos + 218, this.topPos + 218, 16, 16, 0, 0, 16, new ResourceLocation("farout:textures/screens/atlas/imagebutton_zoom_out.png"), 16, 32, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new FormalonMainButtonMessage(3, x, y, z));
				FormalonMainButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
