...
public class MethanePolymerizerRecipesScreen extends AbstractContainerScreen<MethanePolymerizerRecipesMenu> {
	private final static HashMap<String, Object> guistate = MethanePolymerizerRecipesMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MethanePolymerizerRecipesScreen(MethanePolymerizerRecipesMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/methane_polymerizer_recipes.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.farout.methane_polymerizer_recipes.label_electrolyzer"), 42, 7, -12829636, false);
	}
