...
public class HydrogenFuelCellRecipesScreen extends AbstractContainerScreen<HydrogenFuelCellRecipesMenu> {
	private final static HashMap<String, Object> guistate = HydrogenFuelCellRecipesMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public HydrogenFuelCellRecipesScreen(HydrogenFuelCellRecipesMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/hydrogen_fuel_cell_recipes.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.farout.hydrogen_fuel_cell_recipes.label_hydrogen_fuel_cell"), 42, 7, -12829636, false);
	}
