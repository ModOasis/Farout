...
public class ElectrolyzerGUIScreen extends AbstractContainerScreen<ElectrolyzerGUIMenu> {
	private final static HashMap<String, Object> guistate = ElectrolyzerGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ElectrolyzerGUIScreen(ElectrolyzerGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/electrolyzer_gui.png");
