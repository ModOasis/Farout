...
public class CoalGasificationReactorGUIScreen extends AbstractContainerScreen<CoalGasificationReactorGUIMenu> {
	private final static HashMap<String, Object> guistate = CoalGasificationReactorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public CoalGasificationReactorGUIScreen(CoalGasificationReactorGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/coal_gasification_reactor_gui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.farout.coal_gasification_reactor_gui.label_coal_gasification"), 69, 7, -12829636, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.farout.coal_gasification_reactor_gui.label_gasification"), 51, 16, -12829636, false);
	}
