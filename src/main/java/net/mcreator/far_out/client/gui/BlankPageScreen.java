...
public class BlankPageScreen extends AbstractContainerScreen<BlankPageMenu> {
	private final static HashMap<String, Object> guistate = BlankPageMenu.guistate;
	...
	public BlankPageScreen(BlankPageMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/blank_page.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.farout.blank_page.label_rocketry"), 76, 9, -12829636, false);
	}
