...
public class IntegratedCircutFabricatorRecipesScreen extends AbstractContainerScreen<IntegratedCircutFabricatorRecipesMenu> {
	private final static HashMap<String, Object> guistate = IntegratedCircutFabricatorRecipesMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public IntegratedCircutFabricatorRecipesScreen(IntegratedCircutFabricatorRecipesMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/integrated_circut_fabricator_recipes.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.farout.integrated_circut_fabricator_recipes.label_integrated_circuit_fabricator"), 40, 7, -12829636, false);
	}
