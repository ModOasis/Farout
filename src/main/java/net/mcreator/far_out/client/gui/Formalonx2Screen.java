...
import net.mcreator.far_out.network.Formalonx2ButtonMessage;
...
public class Formalonx2Screen extends AbstractContainerScreen<Formalonx2Menu> {
	private final static HashMap<String, Object> guistate = Formalonx2Menu.guistate;
	...
	public Formalonx2Screen(Formalonx2Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/screens/formalonx_2.png");
	...
	public void init() {
		...
		imagebutton_zoom_in = new ImageButton(this.leftPos + 221, this.topPos + 221, 16, 16, 0, 0, 16, new ResourceLocation("farout:textures/screens/atlas/imagebutton_zoom_in.png"), 16, 32, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new Formalonx2ButtonMessage(0, x, y, z));
				Formalonx2ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_settrajectory = new ImageButton(this.leftPos + 127, this.topPos + 23, 16, 16, 0, 0, 16, new ResourceLocation("farout:textures/screens/atlas/imagebutton_settrajectory.png"), 16, 32, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new Formalonx2ButtonMessage(1, x, y, z));
				Formalonx2ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_settrajectory2 = new ImageButton(this.leftPos + 219, this.topPos + 68, 16, 16, 0, 0, 16, new ResourceLocation("farout:textures/screens/atlas/imagebutton_settrajectory2.png"), 16, 32, e -> {
			if (true) {
				FaroutMod.PACKET_HANDLER.sendToServer(new Formalonx2ButtonMessage(2, x, y, z));
				Formalonx2ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
