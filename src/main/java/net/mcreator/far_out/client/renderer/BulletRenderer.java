...
public class BulletRenderer extends EntityRenderer<BulletEntity> {
	private static final ResourceLocation texture = new ResourceLocation("farout:textures/entities/bullettexture.png");
	private final ModelBullet_Converted model;

	public BulletRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelBullet_Converted(context.bakeLayer(ModelBullet_Converted.LAYER_LOCATION));
	}
