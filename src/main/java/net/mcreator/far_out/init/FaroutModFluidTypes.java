...
import net.mcreator.far_out.fluid.types.MagmaFluidType;
...
import net.mcreator.far_out.fluid.types.IronPentacarbonylFluidType;
import net.mcreator.far_out.fluid.types.HydrogenSulfideFluidType;
...
public class FaroutModFluidTypes {
	...
	public static final RegistryObject<FluidType> IRON_PENTACARBONYL_TYPE = REGISTRY.register("iron_pentacarbonyl", () -> new IronPentacarbonylFluidType());
	public static final RegistryObject<FluidType> MAGMA_TYPE = REGISTRY.register("magma", () -> new MagmaFluidType());
	public static final RegistryObject<FluidType> HYDROGEN_SULFIDE_TYPE = REGISTRY.register("hydrogen_sulfide", () -> new HydrogenSulfideFluidType());
}
