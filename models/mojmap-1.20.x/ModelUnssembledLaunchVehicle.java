...
public class ModelUnssembledLaunchVehicle<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "unssembledlaunchvehicle"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(72, 90)
						.addBox(-12.0F, -230.25F, -12.0F, 24.0F, 68.0F, 24.0F, new CubeDeformation(12.0F)).texOffs(0, 0)
						.addBox(-12.0F, -120.0F, -12.0F, 24.0F, 90.0F, 24.0F, new CubeDeformation(18.0F))
						.texOffs(96, 35).addBox(21.0F, -152.0F, -1.0F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-30.0F, -12.0F, 28.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(28.0F, -12.0F, 28.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(28.0F, -12.0F, -30.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-30.0F, -12.0F, -30.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
