...
public class ModelLaunchVehicle<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(72, 90)
				...
				.addBox(-12.0F, -120.0F, -12.0F, 24.0F, 90.0F, 24.0F, new CubeDeformation(18.0F)).texOffs(144, 35)
				.addBox(-10.0F, -303.25F, -10.0F, 20.0F, 49.0F, 20.0F, new CubeDeformation(12.0F)).texOffs(142, 156)
				.addBox(-13.0F, -323.25F, -13.0F, 26.0F, 2.0F, 26.0F, new CubeDeformation(6.0F)).texOffs(0, 162)
				.addBox(-10.0F, -345.25F, -10.0F, 20.0F, 5.0F, 20.0F, new CubeDeformation(2.0F)).texOffs(168, 104)
				...
				.addBox(21.0F, -152.0F, -1.0F, 2.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(96, 0)
				.addBox(-15.0F, -336.25F, -15.0F, 30.0F, 5.0F, 30.0F, new CubeDeformation(2.0F)).texOffs(0, 17)
