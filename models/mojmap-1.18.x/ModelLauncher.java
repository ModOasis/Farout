...
public class ModelLauncher<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "launcher"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Launcher = partdefinition.addOrReplaceChild("Launcher",
				CubeListBuilder.create().texOffs(8, 24)
						.addBox(-1.0F, -172.0F, 0.0F, 1.0F, 17.0F, 1.0F, new CubeDeformation(10.0F)).texOffs(12, 24)
						.addBox(-1.0F, -166.0F, 0.0F, 1.0F, 17.0F, 1.0F, new CubeDeformation(11.0F)).texOffs(4, 0)
						.addBox(-1.0F, -161.0F, 0.0F, 1.0F, 34.0F, 1.0F, new CubeDeformation(12.0F)).texOffs(0, 0)
						.addBox(-1.0F, -108.0F, 0.0F, 1.0F, 103.0F, 1.0F, new CubeDeformation(10.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition fin1_r1 = Launcher
		...
		PartDefinition fin2_r1 = Launcher.addOrReplaceChild("fin2_r1",
		...
		PartDefinition Fin3_r1 = Launcher.addOrReplaceChild("Fin3_r1",
		...
		PartDefinition Fin4_r1 = Launcher.addOrReplaceChild("Fin4_r1",
