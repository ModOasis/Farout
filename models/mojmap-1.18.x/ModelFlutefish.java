...
public class ModelFlutefish<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "flutefish"), "main");
	private final ModelPart PropTentacle2;
	private final ModelPart PropTentacle1;
	private final ModelPart PropTentacle3;
	private final ModelPart PropTentacle4;
	private final ModelPart HuntTentacle1;
	private final ModelPart HuntTentacle2;
	private final ModelPart HuntTentacle3;
	private final ModelPart HuntTentacle4;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition PropTentacle2 = partdefinition.addOrReplaceChild("PropTentacle2", CubeListBuilder.create()
				.texOffs(0, 32).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.0F, 19.0F, 17.0F));

		PartDefinition PropTentacle1 = partdefinition.addOrReplaceChild("PropTentacle1",
				CubeListBuilder.create().texOffs(0, 12).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 10.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 16.0F, 17.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition PropTentacle3 = partdefinition.addOrReplaceChild("PropTentacle3", CubeListBuilder.create()
				.texOffs(24, 32).addBox(2.0F, -6.0F, 17.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition PropTentacle4 = partdefinition.addOrReplaceChild("PropTentacle4", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = PropTentacle4.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 10.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 17.0F, 0.0F, 0.0F, 1.5708F));

		PartDefinition HuntTentacle1 = partdefinition.addOrReplaceChild("HuntTentacle1", CubeListBuilder.create()
				.texOffs(0, 60).addBox(-17.0F, -6.0F, -18.0F, 13.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition HuntTentacle2 = partdefinition.addOrReplaceChild("HuntTentacle2", CubeListBuilder.create(),
				PartPose.offset(10.5F, 19.0F, -17.0F));

		PartDefinition cube_r2 = HuntTentacle2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 60).addBox(-11.5F, -1.0F, -1.0F, 13.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.0F, 0.0F, 0.0F, 3.1416F, 3.1416F, 0.0F));

		PartDefinition HuntTentacle3 = partdefinition.addOrReplaceChild("HuntTentacle3", CubeListBuilder.create(),
				PartPose.offset(10.5F, 19.0F, -17.0F));

		PartDefinition cube_r3 = HuntTentacle3.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 60).addBox(-13.0F, -1.0F, -1.0F, 13.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-10.5F, -4.0F, 0.0F, -1.5708F, 3.1416F, -1.5708F));

		PartDefinition HuntTentacle4 = partdefinition.addOrReplaceChild("HuntTentacle4", CubeListBuilder.create(),
				PartPose.offset(0.25F, 28.8481F, -18.7365F));

		PartDefinition cube_r4 = HuntTentacle4.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 60).addBox(-12.5F, -1.0F, -1.0F, 13.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-1.0F, -6.0F, -16.0F, 2.0F, 2.0F, 30.0F, new CubeDeformation(3.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
