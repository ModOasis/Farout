...
public class ModelSmallRocket<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Fairing = partdefinition.addOrReplaceChild("Fairing",
				CubeListBuilder.create().texOffs(86, 174)
						.addBox(-10.0F, -69.5F, -10.0F, 20.0F, 6.0F, 20.0F, new CubeDeformation(8.0F)).texOffs(112, 160)
						.addBox(-7.0F, -87.5F, -7.0F, 14.0F, 5.0F, 14.0F, new CubeDeformation(5.0F)).texOffs(64, 130)
						.addBox(-13.0F, -49.5F, -15.0F, 25.0F, 44.0F, 30.0F, new CubeDeformation(7.0F)),
				PartPose.offset(0.0F, -146.5F, 0.0F));

		PartDefinition Booster2 = partdefinition.addOrReplaceChild("Booster2",
				CubeListBuilder.create().texOffs(61, 1)
						.addBox(0.0F, 0.0F, -19.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)).texOffs(61, 8)
						.addBox(0.0F, 0.0F, -9.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)).texOffs(8, 72)
						.addBox(-2.0F, -95.0F, -18.0F, 8.0F, 90.0F, 8.0F, new CubeDeformation(5.0F)),
		...
		PartDefinition cube_r1 = Booster2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(1, 8)
						.addBox(0.0F, -5.0F, -7.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)).texOffs(1, 1)
						.addBox(0.0F, -5.0F, 3.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)),
		...
		PartDefinition Booster1 = partdefinition.addOrReplaceChild("Booster1",
				CubeListBuilder.create().texOffs(61, 1)
						.addBox(-1.0F, 0.0F, 14.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)).texOffs(61, 8)
						.addBox(-1.0F, 0.0F, 24.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)).texOffs(8, 72)
						.addBox(-3.0F, -95.0F, 15.0F, 8.0F, 90.0F, 8.0F, new CubeDeformation(5.0F)),
				PartPose.offset(-1.0F, 24.0F, 3.0F));

		PartDefinition cube_r2 = Booster1.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(1, 8)
						.addBox(0.0F, -5.0F, -6.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)).texOffs(1, 1)
						.addBox(0.0F, -5.0F, 4.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)),
		...
		PartDefinition Core = partdefinition.addOrReplaceChild("Core",
				CubeListBuilder.create().texOffs(0, 64)
						.addBox(-8.0F, -95.0F, -8.0F, 16.0F, 90.0F, 16.0F, new CubeDeformation(7.0F)).texOffs(60, 0)
						.addBox(-3.0F, -2.0F, -10.0F, 6.0F, 5.0F, 2.0F, new CubeDeformation(4.0F)).texOffs(60, 7)
						.addBox(-3.0F, -2.0F, 9.0F, 6.0F, 5.0F, 2.0F, new CubeDeformation(4.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r3 = Core.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 7)
						.addBox(-3.0F, 6.0F, -11.0F, 6.0F, 5.0F, 2.0F, new CubeDeformation(4.0F)).texOffs(0, 0)
						.addBox(-3.0F, 6.0F, 9.0F, 6.0F, 5.0F, 2.0F, new CubeDeformation(4.0F)),
		...
		PartDefinition Booster3 = partdefinition.addOrReplaceChild("Booster3",
				CubeListBuilder.create().texOffs(61, 1)
						.addBox(-12.0F, 0.0F, -7.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)).texOffs(61, 8)
						.addBox(-12.0F, 0.0F, 3.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)).texOffs(8, 72)
						.addBox(-14.0F, -95.0F, -6.0F, 8.0F, 90.0F, 8.0F, new CubeDeformation(5.0F)),
				PartPose.offset(-12.0F, 24.0F, 2.0F));
		...
		PartDefinition Booster4 = partdefinition.addOrReplaceChild("Booster4",
				CubeListBuilder.create().texOffs(61, 1)
						...
						.addBox(-12.0F, 0.0F, 3.0F, 3.0F, 5.0F, 1.0F, new CubeDeformation(2.0F)).texOffs(8, 72)
						.addBox(-14.0F, -95.0F, -6.0F, 8.0F, 90.0F, 8.0F, new CubeDeformation(5.0F)),
				PartPose.offset(32.0F, 24.0F, 2.0F));
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(64, 76)
						.addBox(-8.0F, -166.0F, -8.0F, 16.0F, 36.0F, 16.0F, new CubeDeformation(5.0F)).texOffs(62, 46)
						.addBox(-9.0F, -120.0F, -9.0F, 18.0F, 12.0F, 18.0F, new CubeDeformation(7.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
