...
public class ModelSky_Hydrozoan<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sky_hydrozoan"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = Root.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.0F, -9.0F, 0.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(10.0F)).texOffs(0, 5)
						.addBox(-1.5F, -10.0F, 0.5F, 2.0F, 1.0F, 2.0F, new CubeDeformation(10.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Tentacles = Root.addOrReplaceChild("Tentacles", CubeListBuilder.create(),
				PartPose.offset(-0.25F, 21.0F, 0.0F));

		PartDefinition Tentacle1 = partdefinition.addOrReplaceChild("Tentacle1", CubeListBuilder.create().texOffs(12, 4)
				.addBox(-1.0F, -19.0F, -7.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(3.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Tentacle2 = partdefinition.addOrReplaceChild("Tentacle2", CubeListBuilder.create().texOffs(12, 4)
				.addBox(-1.0F, -19.0F, -7.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(3.0F)),
				PartPose.offset(8.0F, 24.0F, 9.0F));

		PartDefinition Tentacle3 = partdefinition.addOrReplaceChild("Tentacle3", CubeListBuilder.create().texOffs(12, 4)
				.addBox(-1.0F, -19.0F, -7.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(3.0F)),
				PartPose.offset(-8.0F, 24.0F, 8.0F));

		PartDefinition Tentacle4 = partdefinition.addOrReplaceChild("Tentacle4", CubeListBuilder.create().texOffs(12, 4)
				.addBox(-1.0F, -19.0F, -7.0F, 1.0F, 11.0F, 1.0F, new CubeDeformation(3.0F)),
