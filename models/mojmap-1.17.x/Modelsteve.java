...
public class Modelsteve<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = SpaceSuit.addOrReplaceChild("RightLeg", CubeListBuilder.create(),
				PartPose.offset(-5.15F, 16.0F, -3.75F));

		PartDefinition LeftLeg = SpaceSuit.addOrReplaceChild("LeftLeg", CubeListBuilder.create(),
